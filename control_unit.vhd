...
architecture behavioral of control_unit is
    ...
    -- Extract the three fields that drive all decoding
    alias opcode : std_logic_vector(6 downto 0) is instruction(6 downto 0);
    alias funct3 : std_logic_vector(2 downto 0) is instruction(14 downto 12);
    alias funct7 : std_logic_vector(6 downto 0) is instruction(31 downto 25);

    -- Opcode constants (from the RISC-V reference card)
    ...
    -- ALU operation codes (match alu.vhd exactly)
        ...
        case opcode is
            ...
            when OP_R =>
                ...
                case funct3 is
                    ...
                    when "101" =>                     -- srl or sra — check funct7 bit 5
            ...
            when OP_I_ALU =>
                ...
                case funct3 is
                    ...
                    when "001" => alu_op <= ALU_SLL;  -- slli  (funct7=0x00)
            ...
            -- mem_size and mem_signed: how the memory unit reads and extends the loaded value
            when OP_LOAD =>
                alu_op     <= ALU_ADD; -- address = rs1 + imm
                alu_src    <= '1';     -- immediate as op_b
                mem_read   <= '1';
                reg_write  <= '1';
                mem_to_reg <= '1';     -- writeback from memory, not ALU
            ...
            -- STORES: sb, sh, sw
            -- ALU computes address: rs1 + sign-extended imm
            -- (For S-type the immediate is split across bits [31:25] and [11:7]
            when OP_STORE =>
                alu_op    <= ALU_ADD; -- address = rs1 + imm
                alu_src   <= '1';     -- immediate as op_b
                mem_write <= '1';
            ...
            -- ALU does the branch target: NPC + (imm << 1)
